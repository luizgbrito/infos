...
var campaignIds = {
    'default': "66a2af576bc8bd00014e4909",
}
var cookieDomain = "fortuneharvesting.com"
...
var initialSrc = "https://rt.fortuneharvesting.com/" + campaignID + "?format=json" + "&referrer=" + referrer;
for (var i = 1; i <= 10; i++) {
...
function setHref(clickID, ref) {
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("https://rt.fortuneharvesting.com/click") > -1) {
...
function xhrrOpenAndSend(clickID, ref) {
    ...
    if (getSessionRegisterViewOncePerSession() !== 1) {
        xhrr.open("GET", "https://rt.fortuneharvesting.com/view?clickid=" + clickID + "&referrer=" + ref)
        xhrr.send();
    }
